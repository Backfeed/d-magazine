...
<div id="comments">
	...
	<?php if ( have_comments() ): ?>
		...
		<h2 class="comments-title">
			<?php comments_number(
				esc_html__( 'No Comments', 'barcelona' ),
				esc_html__( 'One Comment', 'barcelona' ),
				esc_html( _n( '% Comment', '% Comments', number_format_i18n( get_comments_number() ), 'barcelona' ) )
			); ?>
		</h2>
	...
	<?php if ( comments_open() ): ?>
		...
		<?php
			$barcelona_wp_kses_allowable_html = [
				'a' => [
					'href' => [],
					'title' => []
				]
