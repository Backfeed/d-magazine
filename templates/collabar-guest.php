<aside id="backfeed-collabar">
	...
	<section class="hidden-xs-down">
		...
		<div class="backfeed-tagline"><span>We are</span><br>crowdsourced</div>
		<div class="backfeed-learn hidden-lg-up">Register to participate, get compensated for your contribution</div>
